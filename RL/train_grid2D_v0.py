...
if __name__ == '__main__':
    # init
    env = gym.make("gym_examples/CollisionAvoid-v0",render_mode='human')
    # env = make_vec_env("gym_examples/CollisionAvoid-v0",n_envs=8)
    check_env(env,warn=True)
    print("Check Finished,start training...")

    # train
    model = PPO('MlpPolicy', env,verbose=1,n_steps=16,gae_lambda=0.8,gamma=0.98,n_epochs=4,ent_coef=0.0,batch_size=256).learn(1e5)
...
# Create save dir
save_dir = "/tmp/gym/"
model_name = "/CollisionAvoid-Fixed-PPO-1e5"
